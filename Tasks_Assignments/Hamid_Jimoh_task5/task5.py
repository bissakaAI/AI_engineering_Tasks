...
user_input_month = input ("input Month using the format e.gmay is 05: ")
user_input_day = input ("current day number e.g (1-7): ")
correct_month = months_of_year[user_input_month]
correct_day=days_of_the_week[user_input_day]
